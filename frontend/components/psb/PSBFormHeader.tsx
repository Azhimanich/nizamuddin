...
export function PSBFormHeader({ locale = 'id' }: { locale?: string }) {
          ...
          <div className="flex justify-between items-center h-16">
              ...
              <div className="h-12 w-12 relative flex-shrink-0">
                <img
                  ...
                  onError={(e) => {
                    ...
                    if (parent) {
                      parent.innerHTML = '<div class="h-12 w-12 bg-primary-600 rounded-lg flex items-center justify-center"><span class="text-white font-bold text-lg">PN</span></div>'
                    }
                  }}
                />
              </div>
            ...
            <nav className="hidden md:flex items-center space-x-6">
              ...
              <div className="bg-emerald-100 px-4 py-2 rounded-lg">
                <span className="text-emerald-700 font-semibold">PSB {academicYear}</span>
              </div>
            </nav>

            {/* Mobile Menu Button */}
            <div className="md:hidden">
              <button className="p-2 rounded-md text-gray-700 hover:text-emerald-600">
